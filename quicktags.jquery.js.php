...
function edToolbar() {
  ...
  $LAB
  .script("<?php bloginfo('url') ?>/wp-content/plugins/markdown-quicktags/js/jquery.a-tools.min.js")
  .script("<?php bloginfo('url') ?>/wp-content/plugins/markdown-quicktags/js/jquery.asuggest.js") 
  .script("<?php bloginfo('url') ?>/wp-content/plugins/markdown-quicktags/js/jquery.hoverIntent.min.js")
  .script("<?php bloginfo('url') ?>/wp-content/plugins/markdown-quicktags/js/taboverride.js")
  .script("<?php bloginfo('url') ?>/wp-content/plugins/markdown-quicktags/js/jquery.tipsy.js")
  .script("<?php bloginfo('url') ?>/wp-content/plugins/markdown-quicktags/js/textchange.jquery.js").wait(function() { 
